                                                          ...
                                                          <tr>
                                                            <td
                                                              ...
                                                              <img class="max-width" border="0"
                                                                ...
                                                                src="https://i.ibb.co/FzBGYXF/logo.png" height="27">
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px">Please verify your email
                                                                    ...
                                                                    get access to different services provided by
                                                                    ATC</span><span style="font-size: 18px">.</span>
                                                                </div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td align="center" bgcolor="#ffbe00"
                                                                      ...
                                                                      <a href="${process.env.URL}/verify-user?q=${obj.authCode}&u=${obj.userId}"
                                                                        style="background-color:#fd7f2d; border:1px solid #fd7f2d; border-color:#fd7f2d; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
...
`;
  ...
  // let mailOptions = {
  //   from: 'accounts@atccouriers.com.au',
  //   to: `${obj.email}`,
  ...
  const msg = {
    from: 'bookings@atccouriers.com.au',
    to: `${obj.email}`,
    subject: 'Account Verification',
    text: `Please click the link below for verification:
      ${process.env.URL}/verify-user?q=${obj.authCode}&u=${obj.userId}
    `,
    html: html,
  };
